...
/*----- liệt kê danh sách product đa cấp dựa vào Product Cat Id cao nhất -------*/
public function getProductList_byMultiLevel_orderProductId_run($idProductCat,$order_productId,$trang, $limit, $page){
...
public function getProductList_byMultiLevel_orderProductId_brand($idProductCat,$order_productId,$trang, $limit, $page){
    ...
    if ($this->nameColId_product != "" && $order_state != "") {
        ...
        $order = "order by product_sort asc, $this->nameColId_product $order_state ";
    ...
    if ($trang != "" && $limit != "") {
        ...
        if (!empty($_SESSION['size_brand']) || !empty($_SESSION['material_brand']) || !empty($_SESSION['laptop_brand']) || !empty($_SESSION['special']) || !empty($_SESSION['price']) || !empty($_SESSION['color'])) {
            $link = "";
            if (!empty($_SESSION['size_brand'])) {
                $link .= "&size=";
                foreach ($_SESSION['size_brand'] as $item) {
            ...
            $config = array(
                ...
                'link_full'=> $slug != '' ? $slug.'/{trang}' : '/index.php?page=brand&search='.$_GET['search'].$link.'&trang={trang}',

                'link_first'=> $slug != '' ? $slug : '/index.php?page=brand&search='.$_GET['search'].$link,
...
public function getProductList_byMultiLevel_orderProductId_loc($idProductCat,$order_productId,$trang, $limit, $page){
    ...
    if ($this->nameColId_product != "" && $order_state != "") {
        ...
        $order = "order by state asc, product_sort asc, $this->nameColId_product $order_state ";
    ...
    if ($trang != "" && $limit != "") {
        ...
        if (!empty($_SESSION['brand']) || !empty($_SESSION['size']) || !empty($_SESSION['material']) || !empty($_SESSION['special']) || !empty($_SESSION['laptop']) || !empty($_SESSION['price']) || !empty($_SESSION['color'])) {
            ...
            $config = array(
                ...
                'link_full'=> $slug != '' ? $slug.'/{trang}' : '/index.php?page='.$page.$link.'&trang={trang}',

                'link_first'=> $slug != '' ? $slug : '/index.php?page='.$page.$link,
