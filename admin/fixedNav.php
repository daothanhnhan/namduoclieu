        ...
        <ul class="listMenuFL">
            ...
            <li><a href="index.php?page=tai-khoan" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'tai-khoan' || $_GET["page"] == 'sua-tai-khoan' || $_GET["page"] == 'them-tai-khoan') {
                       echo 'sltMenu';
                   } ?>" target="_blank"><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Tài
                    khoản</a></li>

            <!--QUẢN LÝ THƯ VIỆ ẢNH-->
            <li><a href="/admin/ckfinder/ckfinder.html?type=Images&CKEditor=editor1&CKEditorFuncNum=407&langCode=vi" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Thư viện ảnh</a>
            </li>
           ...
           <!-- <li><a href="index.php?page=danh-muc-dich-vu" title=""
            ...
            <li><a href="index.php?page=size" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Quản lý kích thước</a>
            </li>

            <li><a href="index.php?page=slide" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>SliderShow</a>
            </li>

            <li><a href="index.php?page=news-slide" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Slider Tin tức</a>
            </li>

            <li><a href="index.php?page=news-banner" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Banner Tin tức</a>
            </li>

            <li><a href="index.php?page=newletter" title=""
...
<div class="logoTop">
    <a href="/" class="linkLogoTop"><img src="image/logoTopcafe.png" class="imgLogoTop"/></a>
