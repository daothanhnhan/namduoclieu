...
// echo json_encode(array('error'=>'Lỗi, mời thử lại'));die;
			...
			$product_sort = isset($_POST['product_sort']) ? $_POST['product_sort'] : '0';
			...
			$FilePathMain = isset($_POST['FilePathMain']) ? $_POST['FilePathMain'] : '';
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			if ($FilePath != '') { 
				foreach ($file_arr as $item) {
					$sub_img[] = json_encode(array('image'=>$item));
				}
			}
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssiiissssiissssiiisiii');
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
		...
		public function updateProduct(){
			...
			$product_extra = implode(",", $product_extra);
			//////////////
// echo json_encode(array('error'=>'Lỗi, mời thử lại'.$product_sort));die;
			////////////////////
			// $arr_product_size = array();
			// foreach ($product_size as $item) {
			// 	if ($item != '') {
