...
<div id="divWrapper">
    ...
    <div class="coverFormLogin">
        ...
        <form method="post" class="formLogin" id="formLogin">
            ...
            <img src="image/logocfl.png" alt="Cafe Link" class="logoLogin" /> 
        ...
        <p class="endLogin">Công ty TNHH Phát triển Thương hiệu Cafe Link Việt Nam<br /><em style="text-decoration:underline;">Điện thoại:</em> <strong>0375.525.728</strong> - <em style="text-decoration:underline;">Hotline:</em> <strong>0865.689.886</strong><br /><em style="text-decoration:underline;">Website:</em>Cafelink.org</p>
