<?php 
	...
	function slide () {
		...
		if (isset($_POST['add_slide'])) {
			...
			$sql = "INSERT INTO news_banner (name, link, image) VALUES ('$name', '$link', '$image')";
			$result = mysqli_query($conn_vn, $sql);
			echo '<script type="text/javascript">alert(\'Bạn đã thêm được một banner.\');window.location.href="index.php?page=news-banner"</script>';
		}
	}
