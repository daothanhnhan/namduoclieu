<?php 
	...
	function slide ($id) {
		...
		if (isset($_POST['add_slide'])) {
			...
			if ($image == '') {
				$sql = "UPDATE news_slide SET name = '$name', link = '$link' WHERE id = $id";
			} else {
				$sql = "UPDATE news_slide SET name = '$name', link = '$link', image = '$image' WHERE id = $id";
			}
	...
	$getslide = $acc->getDetail('news_slide', 'id', $_GET['id']);
?>
