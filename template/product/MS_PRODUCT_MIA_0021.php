                            ...
                            <div class="col-md-7">
                                <div class="gb-chitiet_sanpham_ruouvang_left-img">
                                    <div class="uni-single-car-gallery-images">
                                        <div class="slider slider-for skills_section" id="img-main-mia">
                                        ...
                                        <div class="slider slider-nav skills_section" id="img-sub-mia">
                                ...
                                <div class="gb-chitiet_sanpham_ruouvang_left-info">
                                    ...
                                    <div class="gb-imagelienquan-miavn">
                                        <ul>
                                            ...
                                            <?php } ?>
                                            <li><a href="#" onclick="proimg(1)"><img src="/images/product4.jpg" alt="" class="img-responsive"></a></li>
                                        </ul>
                                    </div>
                                    <!--ĐẶT HÀNG-->
