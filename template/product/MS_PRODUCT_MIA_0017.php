<?php                                                                        
    ...
    if (isset($_GET['size'])) {
        ...
        foreach ($link_size_arr as $item) {
            if (!in_array($item, $_SESSION['size_brand'])) {
                $_SESSION['size_brand'][] = $item;
            }
        }
    ...
    if (isset($_GET['laptop'])) {
        ...
        foreach ($link_laptop_arr as $item) {
            if (!in_array($item, $_SESSION['laptop_brand'])) {
                $_SESSION['laptop_brand'][] = $item;
            }
        }
    ...
    if (isset($_GET['material'])) {
        ...
        foreach ($link_material_arr as $item) {
            if (!in_array($item, $_SESSION['material_brand'])) {
                $_SESSION['material_brand'][] = $item;
            }
        }
...
<?php include DIR_BREADCRUMBS."MS_BREADCRUMS_MIA_0006.php";?>
