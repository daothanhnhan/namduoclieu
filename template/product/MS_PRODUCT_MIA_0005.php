...
<div class="gb-home-product gb-home-product-relate">
    <div class="container">
        <div class="gb-home-product-relate-title">
            <a href="/phu-kien">PHỤ KIỆN ĐI KÈM<div class="border hidden-xs"></div></a>
            <a href="/phu-kien" class="xemthem-list">Xem tất cả <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
        </div>
